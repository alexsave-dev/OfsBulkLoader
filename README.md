...
The processed OFS file wil be in the directory **./ofs/archive** if the flag **POST.TO.TRANSACT=YES** in the spreadsheet. Otherwise the file will be in the directory **./ofs**.
